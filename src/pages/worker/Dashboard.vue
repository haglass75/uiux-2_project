<template>
  <div
    ...
    <!-- 메인 내용 스크롤 -->
    <main
      class="overflow-y-auto overflow-x-hidden w-full max-h-[calc(100vh-68px)]"
      :style="{
      ...
      <div class="h-full grid grid-cols-3">
        ...
        <router-link
          ...
          <span
            ...
            class="absolute -top-1 w-12 h-1 rounded-full bg-green-600/80 dark:bg-green-400/80"></span>
        </router-link>
      </div>
    </nav>
  </div>
